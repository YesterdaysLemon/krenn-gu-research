...
```powershell
uv run --with sympy python verify_shallow_hafnian_hessian_two_deck_inversion_and_p7_legal_sensor_interface.py
python audit_shallow_hafnian_hessian_two_deck_inversion_and_p7_legal_sensor_interface.py
