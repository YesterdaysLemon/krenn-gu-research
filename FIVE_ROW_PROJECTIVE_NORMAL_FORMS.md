...
The remaining global task is to combine the five local strata with the
mixed-row permanent identities; the theorem above is a reduction of
that task, not a declaration that the prize conjecture is solved.
