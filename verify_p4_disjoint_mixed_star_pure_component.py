...
OVERLAPPING = ROOT / "P4_MIXED_ORIENTATION_PURE_COMPONENT.md"
PRIME_CLASSIFICATION = ROOT / "P4_MIXED_DETERMINANTAL_PRIME_CLASSIFICATION.md"
...
def main() -> None:
    ...
    output_path = (
        ROOT / "tmp" / "p4_disjoint_mixed_star_pure_component_verified.json"
    )
