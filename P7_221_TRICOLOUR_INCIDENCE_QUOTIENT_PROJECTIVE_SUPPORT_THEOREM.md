...
```powershell
uv run --with sympy python verify_p7_221_tricolour_incidence_quotient_projective_support.py
python audit_p7_221_tricolour_incidence_quotient_projective_support.py
