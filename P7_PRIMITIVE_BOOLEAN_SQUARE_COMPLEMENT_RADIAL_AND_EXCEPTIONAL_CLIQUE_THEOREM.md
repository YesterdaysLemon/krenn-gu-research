...
```powershell
uv run --with sympy python verify_p7_primitive_complement_radial_and_exceptional_clique.py
python audit_p7_primitive_complement_radial_and_exceptional_clique.py
