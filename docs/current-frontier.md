...
flowchart TD
  ...
  GLD101 -->|a=0 factor supports / offset closure / full E31 / arbitrary-a / physical and global obligations open| GL
...
| `GLD101` | a=0 norm-support residual and full-E31 obligation | `GL` | Close the retained p=0, p=1, p^2+1, R4, R8, and R110 supports with tracked exact identities; `P=0` and `H2=0` are outside the declared open.  Then address the full `E31=0` wall, arbitrary `a`, physical incidence, and wider chart/source/global coverage. GLD101 itself supplies no `B=C=0` conclusion or physical corollary. |
...
| `GLD101` | remaining a=0 factor-support and E31-wall obligation | `GL` | Prove tracked closures for the retained p=0, p=1, p^2+1, R4, R8, and R110 supports, then address `E31=0`/full-`a` and physical, wider-chart, source, and global coverage. |
