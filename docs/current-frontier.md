...
| `S2AA` | remaining common-three-space obligation | `S2` | Joint cross rank at most six and the multi-boundary, `beta=0`, and collapsed cross-column component types remain open, as do the other S2Q strata and every higher order. |
