...
flowchart TD
  ...
  S2AY -. (1,2,2) / rank <=4 / other rank-five branches .-> S2
  S1 -->|boundary| S3
...
| `S2AY` | remaining common-three-space obligation | `S2` | The complete `(1,1,1)` and `(1,1,2)` Hilbert--Burch profiles are closed.  The `(1,2,2)` profile, joint rank at most four, other S2T component types, other S2Q strata, and every higher order remain open. |
