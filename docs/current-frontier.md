...
flowchart TD
  ...
  GLD82 -->|explicit determinant divisor / frame-quotient divisors / other branches open| GL
...
| `GLD82` | determinant-divisor and remaining component/source cover | `GL` | Cover `det(M_ff)=0`, `gamma_num=0`, and `Omega=0`, then other survivor components/gauges, rank drops, triangles, residual-coordinate and isotropic boundaries, smaller survivor families, off-chart source branches, other roots, and non-star atlases. |
...
| `GLD82` | remaining divisor/component/source-cover obligation | `GL` | Treat `det(M_ff)=0`, `gamma_num=0`, and `Omega=0`, then other survivor components/gauges, rank drops, triangles, residual-coordinate and isotropic boundaries, smaller survivor families, non-star profiles, other root orders, and global resolution. |
...
1. **Maximum-root same-pair target attachment.**  `GLS4` closes the
   ...
   **full-swallow** remainder universally starts at nuisance rank four.  This
   ...
   transfers the same open to the named physical source branch.  Treating its
   explicit determinant, quotient, and frame divisors, covering other survivor
   components/gauges, and closing the triangle, rank-drop, residual-boundary,
   isotropic, smaller-survivor, and other-root branches remain the smallest
   local-to-global obligations.
