...
flowchart TD
  ...
  S2Y -. joint cross rank <=7 remains .-> S2
  S1 -->|boundary| S3
...
| `S2Y` | remaining common-three-space obligation | `S2` | Joint cross rank at most seven and the multi-boundary, `beta=0`, and collapsed cross-column component types remain open, as do the other S2Q strata and every higher order. |
