...
flowchart TD
  ...
  S2AE -. coordinate relation plane / joint rank <=5 .-> S2
  S1 -->|boundary| S3
...
| `S2AE` | remaining common-three-space obligation | `S2` | The coordinate-relation-plane transverse-rank-six case remains open to the uncontracted permanent equations, together with joint rank at most five, other S2T component types, other S2Q strata, and every higher order. |
