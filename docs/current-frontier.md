...
flowchart TD
  ...
  S2X -. joint cross rank <=8 remains .-> S2
  S1 -->|boundary| S3
...
| `S2X` | remaining common-three-space obligation | `S2` | Joint cross rank at most eight and the multi-boundary, `beta=0`, and collapsed cross-column component types remain open, as do the other S2Q strata and every higher order. |
