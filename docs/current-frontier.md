...
flowchart TD
  ...
  S2AC -. transverse rank six / joint rank <=5 remain .-> S2
  S1 -->|boundary| S3
...
| `S2AC` | remaining common-three-space obligation | `S2` | The transverse two-root derivative-rank-six mechanism and joint rank at most five remain open, along with the multi-boundary, `beta=0`, and collapsed cross-column component types, the other S2Q strata, and every higher order. |
