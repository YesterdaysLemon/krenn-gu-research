...
| `S2AF` | remaining common-three-space obligation | `S2` | Joint rank at most five remains open, together with other S2T component types, other S2Q strata, and every higher order. |
