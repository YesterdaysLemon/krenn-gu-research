...
flowchart TD
  ...
  S2AJ -. remaining rank-five boundaries / rank <=4 .-> S2
  S1 -->|boundary| S3
...
| `S2AJ` | remaining common-three-space obligation | `S2` | The support-one transverse kernel, support-two `(3,3)` profile, three Hilbert--Burch coordinate atlases, joint rank at most four, other S2T component types, other S2Q strata, and every higher order remain open. |
