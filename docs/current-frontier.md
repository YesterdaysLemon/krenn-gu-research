...
flowchart TD
  ...
  GLD90 -->|H4 Q6 and L1/L2/e boundaries / pulled-back Fitting / other branches open| GL
...
| `GLD90` | H4 Q6/L1/L2/e boundaries, Fitting, and remaining component/source cover | `GL` | Analyze `Q6=0` and the `L1/L2/e` coefficient boundaries, compute the GLD83 pullback with full raw response incidence on `C_F` rank drops, and then cover remaining gauges, components, sources, profiles, roots and orders. |
