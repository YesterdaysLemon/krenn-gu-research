...
| `S2AI` | remaining common-three-space obligation | `S2` | The support-one transverse kernel, support-two `(3,3)` and `(3,2)` profiles, three Hilbert--Burch coordinate atlases, joint rank at most four, other S2T component types, other S2Q strata, and every higher order remain open. |
