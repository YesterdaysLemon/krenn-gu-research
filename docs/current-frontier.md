...
flowchart TD
  ...
  GLD83 -->|intrinsic quadratic Fitting rank-drop / other components and branches open| GL
...
| `GLD83` | intrinsic rank-drop and remaining component/source cover | `GL` | Treat `V(I_Pl)` by a finite minor/component cover or stronger projective certificate, then cover frame/gauge and other survivor components, rank drops, triangles, residual-coordinate and isotropic boundaries, smaller survivor families, off-chart source branches, other roots, and non-star atlases. |
...
| `GLD83` | remaining intrinsic Fitting/component/source-cover obligation | `GL` | Analyze `V(I_Pl)` by constructing a finite centre-rank survivor chart cover or a stronger saturated projective certificate.  Then cover other survivor components/gauges, lower ranks, triangles, residual-coordinate and isotropic boundaries, smaller survivor families, non-star profiles, other root orders, and global resolution. |
