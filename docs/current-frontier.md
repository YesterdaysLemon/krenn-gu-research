...
flowchart TD
  ...
  S2AP -. coordinate-distinct / other Hilbert--Burch boundaries .-> S2
  S1 -->|boundary| S3
...
| `S2AP` | remaining common-three-space obligation | `S2` | The repeated-coordinate `(1,1,1)` chart is closed.  Coordinate-distinct and other allowed `(1,1,1)` charts, the other Hilbert--Burch profiles, and all lower or external branches remain open. |
