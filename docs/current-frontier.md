...
flowchart TD
  ...
  S2AQ -. exactly-two-coordinate noncoordinate / other Hilbert--Burch boundaries .-> S2
  S1 -->|boundary| S3
...
| `S2AQ` | remaining common-three-space obligation | `S2` | Every `(1,1,1)` chart with three coordinate factors is closed.  The exactly-two-coordinate/noncoordinate chart, the other Hilbert--Burch profiles, and all lower or external branches remain open. |
