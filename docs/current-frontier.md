...
flowchart TD
  ...
  S2AG -. rank-five coordinate boundaries / rank <=4 .-> S2
  S1 -->|boundary| S3
...
| `S2AG` | remaining common-three-space obligation | `S2` | The transverse rank-two uninvolved row, three Hilbert--Burch coordinate atlases, joint rank at most four, other S2T component types, other S2Q strata, and every higher order remain open. |
