...
flowchart TD
  ...
  GLD96 -->|arbitrary-p R31/double-pivot and exceptional loci / p=2 fibre handled by GLD97 / Fitting / other branches open| GL
...
| `GLD96` | In the normalized H4 offset chart on `V(Q6) intersect D(R31 E31 H2 g0 Delta)`, four exact bordered seven-minors force the GLD88 offsets `B=C=0`; GLD95 then excludes the written F88 endpoint on `D(Omega)`.  This is a proved generic localization, not closure of `R31=0`, its exceptional factors, arbitrary H4/Q6 points, the Fitting pullback, or the global conjecture. | [H4 Q6 generic R31 resultant localization](../claims/arbitrary-order/FOUR_ROOT_TORUS_STAR_EQUAL_LEAF_H4_Q6_R31_GENERIC_RESULTANT_EXCLUSION_THEOREM.md), [hostile review](audits/FOUR_ROOT_TORUS_STAR_EQUAL_LEAF_H4_Q6_R31_GENERIC_RESULTANT_EXCLUSION_REVIEW_2026-08-28.md) |
...
| `GLD96` | arbitrary-p R31/double-pivot and E31/g0/H2 exceptional strata, arbitrary H4 Q6 outside F88, Fitting, and remaining component/source cover | `GL` | Analyze the retained arbitrary-p and exceptional loci, compute the GLD83 pullback with full raw response incidence on `C_F` rank drops, and cover remaining gauges, components, sources, profiles, roots and orders. |
...
| `GLD96` | arbitrary-p R31/double-pivot, E31/g0/H2 exceptional strata, arbitrary H4 Q6 outside F88 and global Fitting/component/source-cover obligation | `GL` | Analyze the retained arbitrary-p and exceptional loci, arbitrary H4 Q6 points outside F88, compute the GLD83 Fitting pullback, and then cover other components/gauges, lower ranks, source branches, profiles, roots, orders and global resolution. |
