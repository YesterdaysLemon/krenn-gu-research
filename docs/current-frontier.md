...
flowchart TD
  ...
  S2Z -. two-root rank seven / rank <=6 remain .-> S2
  S1 -->|boundary| S3
...
| `S2Z` | remaining common-three-space obligation | `S2` | Rank seven with at least two root blocks, joint rank at most six, and the multi-boundary, `beta=0`, and collapsed cross-column component types remain open, as do the other S2Q strata and every higher order. |
