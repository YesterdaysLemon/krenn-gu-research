...
flowchart TD
  ...
  S2AU -. repeated outer lines / outer coordinate charts / rank <=4 .-> S2
  S1 -->|boundary| S3
...
| `S2AU` | remaining common-three-space obligation | `S2` | The complete `(1,1,1)` profile and the distinct-colour central `(1,1,2)` chart away from repeated outer lines are closed.  Those lines, same-colour and outer coordinate charts, `(1,2,2)`, and all lower or external branches remain open. |
