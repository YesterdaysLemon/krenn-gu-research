...
flowchart BT
  ...
  PSFD -->|global component targets plus mixed slices remain open| GL
...
| `PSFD` | boundary | `GL` | The controls fail an explicit global component-constant equation. They do not refute Q4: every component-constant target together with every depth-four source equation. Q4 and arbitrary-source coverage remain open. |
