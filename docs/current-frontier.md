...
flowchart TD
  ...
  GLS71 -->|remaining five-/six-deficient shared-deck integrability| GL
...
| `GLS71` | remaining five-/six-deficient shared-deck integrability obligation | `GL` | Treat Family A `r=1,2,3`, the all-`T_0` Family B `r=3` quotient, every pure/zero-triangle six-deficient profile, and both five-deficient residuals separately.  Resolve the unique-nonrigid/alternate-receiver branch plus every response, selector, nuisance-survival, activity, anchor, arbitrary-root attachment, and nonzero-anchor gate independently. |
