...
flowchart TD
  ...
  GLS68 -->|same-source pullback integrability / five-six deficient open| GL
...
| `GLS68` | same-source pullback integrability / higher-deficiency successor | `GL` | Compare the six probe-dependent two-port decks as cofactors of one physical matching tensor, polarize the full `(3,3)` identity or prove a genuine fixed-edge descent, and separately classify the five-/six-deficient minimal-open leaves.  Resolve the unique-nonrigid/alternate-receiver branch plus every response, selector, nuisance-survival, activity, anchor, arbitrary-root attachment, and nonzero-anchor gate. |
...
1. **Maximum-root same-pair target attachment.**  `GLS4` closes the
   ...
   **full-swallow** remainder universally starts at nuisance rank four.  This
   ...
   next four-deficient obligation.  Five- and six-deficient profiles remain
   separate higher leaves.
