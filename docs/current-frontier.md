...
flowchart TD
  ...
  S2AL -. remaining rank-five boundaries / rank <=4 .-> S2
  S1 -->|boundary| S3
...
| `S2AL` | remaining common-three-space obligation | `S2` | The support-one `(2,2)` profile, three Hilbert--Burch coordinate atlases, joint rank at most four, other S2T component types, other S2Q strata, and every higher order remain open. |
