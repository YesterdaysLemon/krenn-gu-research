...
| `PSDT` | unresolved supplier | `RSTC` | C8 transport and escape do not establish a resource partition or two-exit closure. The reverse singleton can cancel without propagating another C8. A mixed-row complementary-resource or global consistency lemma is still needed. |
