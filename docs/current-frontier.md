...
flowchart TD
  ...
  GLD74 -->|whole survivor locus / source presentations / maximum-root bridge open| GL
...
| `GLD74` | survivor-locus and source-presentation globalization | `GL` | Globalize the response obstruction from the one exact `GLD72` tensor to the fixed-star GHZ-survivor locus, or prove that every relevant source presentation is forced through the excluded effective interface.  Maximum-root/no-fifth-root certification, other roots, non-star atlases, and global coverage remain separate. |
...
| `GLD74` | remaining universal source-interface obligation | `GL` | Extend the fixed-point obstruction across the survivor locus or establish a proved bridge forcing every relevant graph/source presentation into this canonical torus-star effective model.  Maximum-root/no-fifth-root certification, non-star and lower-rank profiles, other root orders, and global resolution remain open. |
...
1. **Maximum-root same-pair target attachment.**  `GLS4` closes the
   ...
   **full-swallow** remainder universally starts at nuisance rank four.  This
   ...
   complete `q_0` first response in this fixed effective model.  The live
   parent target is now globalization across the survivor locus or a proved
   bridge forcing all relevant source presentations through this interface;
   maximum-root certification, fifth-root exclusion, non-star coverage, and
   global resolution remain separate.
