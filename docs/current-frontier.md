...
flowchart TD
  ...
  S2AM -. Hilbert--Burch rank-five boundaries / rank <=4 .-> S2
  S1 -->|boundary| S3
...
| `S2AM` | remaining common-three-space obligation | `S2` | The three Hilbert--Burch coordinate atlases, joint rank at most four, other S2T component types, other S2Q strata, and every higher order remain open. |
