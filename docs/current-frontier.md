...
flowchart TD
  ...
  S2AK -. remaining rank-five boundaries / rank <=4 .-> S2
  S1 -->|boundary| S3
...
| `S2AK` | remaining common-three-space obligation | `S2` | The support-one transverse kernel, three Hilbert--Burch coordinate atlases, joint rank at most four, other S2T component types, other S2Q strata, and every higher order remain open. |
