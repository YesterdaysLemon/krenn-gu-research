...
flowchart TD
  ...
  S2AD -. coordinate relation / rank-two / joint rank <=5 .-> S2
  S1 -->|boundary| S3
...
| `S2AD` | remaining common-three-space obligation | `S2` | Coordinate relation planes and aligned rank-two transverse-rank-six cases remain open to the uncontracted permanent equations, together with joint rank at most five, other S2T component types, other S2Q strata, and every higher order. |
