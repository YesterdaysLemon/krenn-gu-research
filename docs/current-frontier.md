...
flowchart TD
  ...
  S2AZ -. nine (1,2,2) coloops / rank <=4 / other branches .-> S2
  S1 -->|boundary| S3
...
| `S2AZ` | remaining common-three-space obligation | `S2` | The complete `(1,1,1)` and `(1,1,2)` Hilbert--Burch profiles are closed.  The nine `(1,2,2)` coordinate-coloop orientations, joint rank at most four, other S2T component types, other S2Q strata, and every higher order remain open. |
