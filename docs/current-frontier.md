...
flowchart TD
  ...
  S2AR -. other Hilbert--Burch boundaries / rank <=4 .-> S2
  S1 -->|boundary| S3
...
| `S2AR` | remaining common-three-space obligation | `S2` | The complete Hilbert--Burch `(1,1,1)` profile is closed.  The `(1,1,2)` and `(1,2,2)` profiles and all lower or external branches remain open. |
