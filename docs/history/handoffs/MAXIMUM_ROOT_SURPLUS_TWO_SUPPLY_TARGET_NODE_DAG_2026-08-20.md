...
Current target-envelope-tranche base: `origin/main` at
`8f692aa804861acdcf699874ab179db8b42e07fa`
...
21. **Zero-anchor target-envelope package (current tranche).**  Prove the exact
...
22. **Target exchange-syzygy package.**  Prove the cross-target transport defect
    ...
    implication.
23. **Remaining mixed and exceptional-fibre package.**  Exclude the GLS28
    deletion-stable redundant cover and the C12/C21/C22 witness loci, and prove
...
24. **Closure audit package.**  Independent no-import replay, hostile
