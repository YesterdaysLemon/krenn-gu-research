...
```powershell
uv run --with sympy python verify_graph_extraction_top_two_port_synchronization_observability_boundary.py
python audit_graph_extraction_top_two_port_synchronization_observability_boundary.py
