...
```powershell
uv run --with sympy python verify_p7_vacuum_free_dual_wick_projectivization_and_empty_scalar_escape.py
python audit_p7_vacuum_free_dual_wick_projectivization_and_empty_scalar_escape.py
