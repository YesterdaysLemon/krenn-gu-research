...
```powershell
uv run --with sympy python claims/p7/verify_p7_structured_cubic_boolean_lefschetz_transport_and_middle_hessian_vanishing.py
python claims/p7/audit_p7_structured_cubic_boolean_lefschetz_transport_and_middle_hessian_vanishing.py
python -m py_compile claims/p7/verify_p7_structured_cubic_boolean_lefschetz_transport_and_middle_hessian_vanishing.py claims/p7/audit_p7_structured_cubic_boolean_lefschetz_transport_and_middle_hessian_vanishing.py
uv run --with ruff ruff check claims/p7/verify_p7_structured_cubic_boolean_lefschetz_transport_and_middle_hessian_vanishing.py claims/p7/audit_p7_structured_cubic_boolean_lefschetz_transport_and_middle_hessian_vanishing.py
```
