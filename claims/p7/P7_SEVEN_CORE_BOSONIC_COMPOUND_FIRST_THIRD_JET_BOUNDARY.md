...
uv run --with sympy --with ruff python -m ruff check claims/p7/verify_p7_seven_core_bosonic_compound_first_third_jet_boundary.py claims/p7/audit_p7_seven_core_bosonic_compound_first_third_jet_boundary.py
python -m py_compile claims/p7/verify_p7_seven_core_bosonic_compound_first_third_jet_boundary.py claims/p7/audit_p7_seven_core_bosonic_compound_first_third_jet_boundary.py
```
