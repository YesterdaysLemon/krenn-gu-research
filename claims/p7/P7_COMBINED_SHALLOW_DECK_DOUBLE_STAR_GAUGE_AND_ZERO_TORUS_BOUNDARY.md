...
```powershell
uv run --with sympy python claims/p7/verify_p7_combined_shallow_deck_double_star_gauge.py
python claims/p7/audit_p7_combined_shallow_deck_double_star_gauge.py
python -m py_compile claims/p7/verify_p7_combined_shallow_deck_double_star_gauge.py claims/p7/audit_p7_combined_shallow_deck_double_star_gauge.py
uv run --with ruff ruff check claims/p7/verify_p7_combined_shallow_deck_double_star_gauge.py claims/p7/audit_p7_combined_shallow_deck_double_star_gauge.py
```
