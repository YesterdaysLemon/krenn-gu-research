...
```powershell
uv run --with sympy python verify_p7_physical_extension_mixed_hard_lefschetz_sign_chamber_and_one_exceptional_orbit.py
python audit_p7_physical_extension_mixed_hard_lefschetz_sign_chamber_and_one_exceptional_orbit.py
python -m py_compile verify_p7_physical_extension_mixed_hard_lefschetz_sign_chamber_and_one_exceptional_orbit.py audit_p7_physical_extension_mixed_hard_lefschetz_sign_chamber_and_one_exceptional_orbit.py
uv run --with ruff ruff check verify_p7_physical_extension_mixed_hard_lefschetz_sign_chamber_and_one_exceptional_orbit.py audit_p7_physical_extension_mixed_hard_lefschetz_sign_chamber_and_one_exceptional_orbit.py
```
