...
```powershell
uv run --with sympy python verify_p7_physical_extension_boolean_square_projective_stationarity.py
python audit_p7_physical_extension_boolean_square_projective_stationarity.py
