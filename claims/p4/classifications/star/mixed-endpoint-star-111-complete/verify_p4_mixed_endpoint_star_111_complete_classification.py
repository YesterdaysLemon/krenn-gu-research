...
OVERLAPPING = REPO_ROOT / "claims/p4/classifications/P4_OVERLAPPING_MIXED_ORIENTATION_PROJECTIVE_EXHAUSTION.md"
DISJOINT = (
...
CYCLIC_SINGLETON = REPO_ROOT / "claims/p4/boundaries/P4_CYCLIC_RANK_ONE_TRIANGLE_SUPPORT_ONE_BOUNDARY.md"
ONE_KERNEL_TRIANGLE = REPO_ROOT / "claims/p4/classifications/P4_ONE_KERNEL_RANK_ONE_TRIANGLE_NORMAL_FORM_REDUCTION.md"
