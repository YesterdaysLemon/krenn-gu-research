#!/usr/bin/env python3
"""Verify component 25's exceptional-weight linear-solve divisors."""
...
groebner_basis = sp.groebner(quadrics, x, y, order="grevlex", domain=sp.QQ)
assert groebner_basis.polys == [sp.Poly(1, x, y, domain=sp.QQ)]
