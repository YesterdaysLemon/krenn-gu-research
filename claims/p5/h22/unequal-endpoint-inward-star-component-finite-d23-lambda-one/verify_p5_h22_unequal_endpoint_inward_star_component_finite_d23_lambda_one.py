#!/usr/bin/env python3
"""Exact finite-D23 lambda=1 analysis for component twenty-five."""
...
def module_check(alpha, beta, extensions, hypersurface):
    tensor = coordinates(alpha, beta, extensions, "D23", "finite", sp.Integer(1))
    rows = {
...
def main():
    ...
    canonical = coordinates(alpha, beta, extensions, "D23", "finite", sp.Integer(1))
    assert all(
