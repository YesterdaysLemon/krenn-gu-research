...
```text
python \
  claims/p5/h22/disjoint-mixed-star/boundaries/verify_p5_h22_disjoint_mixed_star_parameter_pivot_boundary_obstruction.py

python \
  claims/p5/h22/disjoint-mixed-star/boundaries/audit_p5_h22_disjoint_mixed_star_parameter_pivot_boundary_obstruction.py
```
