...
Three linear slope graphs are also closed, including one genuine
mode-zero degeneration repaired by a mode-one Fitting minor:
...
```text
python \
  claims/p5/h22/disjoint-mixed-star/boundaries/verify_p5_h22_disjoint_mixed_star_zero_slope_boundary_obstruction.py

python \
  claims/p5/h22/disjoint-mixed-star/boundaries/audit_p5_h22_disjoint_mixed_star_zero_slope_boundary_obstruction.py
```
