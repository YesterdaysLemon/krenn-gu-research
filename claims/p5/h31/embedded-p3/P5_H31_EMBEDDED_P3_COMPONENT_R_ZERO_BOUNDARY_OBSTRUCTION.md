...
```text
python claims/p5/h31/embedded-p3/verify_p5_h31_embedded_p3_component_r_zero_boundary.py
python claims/p5/h31/embedded-p3/audit_p5_h31_embedded_p3_component_r_zero_boundary.py
```
