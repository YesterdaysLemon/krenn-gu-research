#!/usr/bin/env python3
"""Independent DP-permanent audit of the endpoint t2=x divisor."""
...
def main() -> None:
    q0 = verify_endpoint(0, 1, dp_mixed_builder)
    ...
    assert primary_output["whole_regular_t2_divisor_closed"] is True
