...
expose_claim_package(REPO_ROOT, "claims/p5/h31/elliptic-middle-coordinate-rank-drop")
...
def main() -> None:
    ...
    output_path = (
        REPO_ROOT / 'tmp/p5_h31_elliptic_middle_coordinate_pivot_complement_audited.json'
    )
