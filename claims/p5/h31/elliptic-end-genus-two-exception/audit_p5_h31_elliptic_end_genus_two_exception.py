...
Q3_AUDIT = REPO_ROOT / 'claims/p5/h31/elliptic-end-genus-two-q3/audit_p5_h31_elliptic_end_genus_two_q3.py'
...
def main() -> None:
    ...
    output_path = (
        REPO_ROOT / 'tmp/p5_h31_elliptic_end_genus_two_exception_audited.json'
    )
