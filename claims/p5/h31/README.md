...
marked-`H31` claim package: theorem document + primary verifier +
...
The H31 diagonal-quadric **elliptic** generic theorem and the
embedded-p3 / common-active-binary-triangle generic documents remain
at the repository root with their boundary forests: their generic
cores are not separable from their descendant evidence at this
granularity.  Migration status changes no theorem claim; the global
