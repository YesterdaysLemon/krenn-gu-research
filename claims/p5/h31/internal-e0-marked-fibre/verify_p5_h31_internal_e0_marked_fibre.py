...
expose_claim_package(REPO_ROOT, "claims/p5/h31/toric-marked-fibre")
...
GENERATOR = REPO_ROOT / "claims/p5/h31/toric-marked-fibre/derive_p5_h31_toric_marked_fibre_elimination.py"
