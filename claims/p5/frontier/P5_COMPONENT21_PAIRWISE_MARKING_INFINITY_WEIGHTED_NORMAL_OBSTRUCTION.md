...
uv run --with sympy --with ruff python -m ruff check .\verify_p5_component21_pairwise_marking_infinity_weighted_normal_obstruction.py .\audit_p5_component21_pairwise_marking_infinity_weighted_normal_obstruction.py
uv run --with sympy python -m py_compile .\verify_p5_component21_pairwise_marking_infinity_weighted_normal_obstruction.py .\audit_p5_component21_pairwise_marking_infinity_weighted_normal_obstruction.py
```
