...
```powershell
python claims/p5/boundaries/verify_p5_component21_vertical_u0_projective_boundary_complete_obstruction.py
python claims/p5/boundaries/audit_p5_component21_vertical_u0_projective_boundary_complete_obstruction.py
python -m ruff check claims/p5/boundaries/verify_p5_component21_vertical_u0_projective_boundary_complete_obstruction.py claims/p5/boundaries/audit_p5_component21_vertical_u0_projective_boundary_complete_obstruction.py
python -m py_compile claims/p5/boundaries/verify_p5_component21_vertical_u0_projective_boundary_complete_obstruction.py claims/p5/boundaries/audit_p5_component21_vertical_u0_projective_boundary_complete_obstruction.py
```
