"""Standalone recursive-permanent audit of the GLD47 reverse closure."""
...
def amplitudes(case):
    if case == "minus_one":
        return {
            (0, 0, 2): sp.Integer(-1), (0, 2, 0): W,
            (1, 2, 0): sp.Rational(1, 2), (1, 0, 2): W / (W - 1),
        }
    return {
        (0, 0, 2): U, (0, 2, 0): -1 / U,
        (1, 2, 0): U / (U - 1), (1, 0, 2): 1 / (U + 1),
    }
...
def main():
    ...
    print(
        "PASS: standalone recursive-permanent audit derives both GLD47 "
        "reverse-orbit exceptional-divisor contradictions"
    )
