"""Standalone recursive-permanent audit of the GLD52 three-out-star closure."""
    ...
    for index, port in enumerate(ports):
        ...
        if entry:
            total += entry * permanent(
                rows[1:], ports[:index] + ports[index + 1 :], root_word, port_word, case
            )
...
def main():
    ...
    print("PASS: standalone recursive-permanent audit derives both GLD52 contradictions")
