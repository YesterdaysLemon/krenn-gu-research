...
no hypothetical witness exists.  Together with `GLD36` and `GLD37`, this
closes three of the five `GLD31` divisors.  The divisors
`uv+vw+w+1=0` and `p=0` remain open.  The global Krenn--Gu conjecture
remains **UNRESOLVED**.
