"""Matching-type audit of the GLD29 uv-u-v-1 directed-spur divisor."""
...
from verify_fixed_q_dense_directed_spur_uv_minus_u_minus_v_minus_one_divisor_exclusion import (
    COMMON_CURVE_KEYS,
    CYLINDER_KEYS,
...
def main():
    ...
    print("PASS: matching-type audit closes the full GLD29 uv-u-v-1 directed-spur divisor")
