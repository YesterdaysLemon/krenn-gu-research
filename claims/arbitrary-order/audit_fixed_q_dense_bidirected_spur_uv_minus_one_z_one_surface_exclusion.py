"""Standalone recursive-permanent audit of the GLD34 z=1 surface."""
...
FIRST_KEYS = (key("1202", "0212"), key("2212", "2212"))
SECOND_KEYS = (key("0122", "1022"), key("1222", "1222"))
...
def main():
    ...
    assert first_vector == [1, -W]
    assert sp.factor(first_detector - W) == 0
    assert second_vector == [1, 1 / U]
    assert sp.factor(second_detector + 1 / U) == 0
    print("PASS: standalone recursive-permanent audit independently derives both GLD34 contradictions")
