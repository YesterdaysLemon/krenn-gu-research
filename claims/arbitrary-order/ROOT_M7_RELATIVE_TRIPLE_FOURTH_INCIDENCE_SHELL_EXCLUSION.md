...
uv run --with sympy --with ruff python -m ruff check claims/arbitrary-order/verify_root_m7_relative_triple_fourth_incidence_shell_exclusion.py claims/arbitrary-order/audit_root_m7_relative_triple_fourth_incidence_shell_exclusion.py
python -m py_compile claims/arbitrary-order/verify_root_m7_relative_triple_fourth_incidence_shell_exclusion.py claims/arbitrary-order/audit_root_m7_relative_triple_fourth_incidence_shell_exclusion.py
```
