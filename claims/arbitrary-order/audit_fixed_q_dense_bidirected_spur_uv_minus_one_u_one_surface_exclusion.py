"""Standalone recursive-permanent audit of the GLD33 u=1 surface."""
...
def keys(words):
    return tuple(key(*pair) for pair in words)


DETECTOR_A_KEYS = keys((("0011", "0011"), ("0010", "0010"), ("0011", "0000"), ("0002", "0002"), ("1000", "1000"), ("0100", "1000"), ("0100", "0100"), ("1000", "0100"), ("1100", "0000"), ("0110", "0000"), ("0101", "0000"), ("1010", "0000"), ("0102", "0102")))
DETECTOR_B_KEYS = keys((("0011", "0011"), ("0010", "0010"), ("0011", "0000"), ("0002", "0002"), ("1000", "1000"), ("0100", "1000"), ("0100", "0100"), ("1000", "0100"), ("0100", "0010"), ("1100", "0000"), ("0110", "0000"), ("1010", "0000"), ("1010", "1010"), ("0100", "1110")))
CURVE_KEYS = keys((("0011", "0011"), ("0010", "0010"), ("0011", "0000"), ("0002", "0002"), ("1000", "1000"), ("0100", "1000"), ("0100", "0100"), ("1000", "0100"), ("1100", "0000"), ("0110", "0000"), ("0101", "0000"), ("0102", "0102"), ("1110", "0010")))
POINT_KEYS = keys((("0011", "0011"), ("0010", "0010"), ("0011", "0000"), ("0002", "0002"), ("1000", "1000"), ("0100", "1000"), ("0100", "0100"), ("1000", "0100"), ("1100", "0000"), ("0110", "0000"), ("1010", "0000"), ("0120", "0120")))
...
def derive(row_keys, substitutions):
    rows, rhs = [], []
    ...
    return sp.factor(sum(value * target for value, target in zip(vector, rhs, strict=True)))


def main():
    surface = {U: 1, V: -1}
    assert sp.factor(derive(DETECTOR_A_KEYS, surface) - 4 * W * Z * (W * Z - 2) * (W * Z + 1)) == 0
    assert sp.factor(derive(DETECTOR_B_KEYS, surface) + 2 * W * Z * (Z + 1) * (W * Z - 2)) == 0
    assert sp.factor(derive(CURVE_KEYS, {**surface, W: 2 / Z}) - 24 / Z) == 0
    assert sp.factor(derive(POINT_KEYS, {**surface, W: 1, Z: -1}) - 6) == 0
    print("PASS: standalone recursive-permanent audit independently derives all GLD33 contradictions")
