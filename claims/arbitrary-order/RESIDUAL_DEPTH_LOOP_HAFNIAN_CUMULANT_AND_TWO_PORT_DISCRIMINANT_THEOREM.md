...
python -m py_compile claims/arbitrary-order/verify_residual_depth_loop_hafnian_cumulant_and_two_port_discriminant.py claims/arbitrary-order/audit_residual_depth_loop_hafnian_cumulant_and_two_port_discriminant.py
uv run --with ruff ruff check claims/arbitrary-order/verify_residual_depth_loop_hafnian_cumulant_and_two_port_discriminant.py claims/arbitrary-order/audit_residual_depth_loop_hafnian_cumulant_and_two_port_discriminant.py
```
