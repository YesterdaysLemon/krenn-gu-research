"""Primary 945-match replay for the GLD52 three-out-star closure."""
...
CASES = {
    "minus_one": {
        "keys": (
            ("1001", "0011"), ("0001", "0001"), ("0010", "0010"),
            ("0020", "0020"), ("1000", "0001"), ("0002", "0002"),
            ("0110", "0000"), ("0101", "0000"), ("1000", "0100"),
            ("0100", "0100"), ("0011", "0000"), ("0200", "0200"),
            ("1000", "0010"), ("0000", "0011"), ("0011", "0011"),
        ),
        "weights": (
            -2 / V, 1, 2 * (V - 2) / (V - 1), -(2 * V - 3) / (V - 1),
            -1, sp.Rational(-1, 2), 1, 1, -1 / U, 1, -1,
            -(U - 2) / (U - 1), 1 / V, -2 * (V - 2) / (V * (V - 1)),
            2 / (V - 1),
        ),
        "denominator": 2 * U * V * (U - 1) * (V - 1),
    },
    "sum_surface": {
        "keys": (
            ("1001", "0000"), ("1000", "0100"), ("0100", "0100"),
            ("0012", "0012"), ("0010", "0010"), ("0002", "0002"),
            ("0200", "0200"), ("0020", "0020"), ("1000", "0010"),
            ("1000", "0001"), ("0001", "0001"), ("0110", "0000"),
            ("0101", "0000"), ("0011", "0000"),
        ),
        "weights": (
            2 / (W + 1), -1 / U, 1, -2 / (W + 1), (W + 3) / (W + 1),
            (W - 2) / (W - 1), -(U - 2) / (U - 1), -(W + 3) / (W + 2),
            1 / (W + 1), 1 / W, -1, 1, 1, 1,
        ),
        "denominator": U * W * (U - 1) * (W - 1) * (W + 1) * (W + 2),
    },
}
...
def amplitudes(case):
    if case == "minus_one":
        return {
            (0, 0, 1): U, (1, 1, 0): U / (U - 1),
            (0, 0, 2): V, (1, 2, 0): V / (V - 1),
            (0, 0, 3): sp.Integer(-1), (1, 3, 0): sp.Rational(1, 2),
        }
    return {
        (0, 0, 1): U, (1, 1, 0): U / (U - 1),
        (0, 0, 2): -W - 1, (1, 2, 0): (W + 1) / (W + 2),
        (0, 0, 3): W, (1, 3, 0): W / (W - 1),
    }
...
def main():
    ...
    print("PASS: 945-match expansion closes both GLD52 three-out-star exceptional surfaces")
